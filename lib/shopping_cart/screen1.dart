...
import 'package:provider_practice/shopping_cart/screen2.dart';

class ShoppingCartScreen1 extends StatelessWidget {
  const ShoppingCartScreen1({super.key});
            ...
            ElevatedButton(
              onPressed: () {
                Navigator.push(context, MaterialPageRoute(builder: (context) {
                  return const ShoppingCartScreen2();
                }));
              },
